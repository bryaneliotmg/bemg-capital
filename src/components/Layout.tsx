...
export function Layout() {
  ...
  return (
    <div className="flex min-h-screen bg-background text-on-surface font-sans text-sm">
      <Sidebar />
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-xl border-b border-outline-variant px-10 py-[22px] flex items-center justify-between">
          <div>
            <div className="text-xl font-extrabold tracking-tight">{meta.title}</div>
            <div className="text-[12.5px] text-on-surface-variant mt-0.5">{meta.subtitle}</div>
          </div>
          <div className="flex items-center gap-3.5">
            <div className="flex items-center gap-1.5 px-3.5 py-2 rounded-full bg-emerald-50 border border-emerald-200">
